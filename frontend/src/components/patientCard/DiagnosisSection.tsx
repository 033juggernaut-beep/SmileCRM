...
interface DiagnosisSectionProps {
  diagnosis: string
  onSave: (diagnosis: string) => void | Promise<void>
  defaultOpen?: boolean
}
...
export function DiagnosisSection({
  ...
  return (
    <CollapsibleSection title={t('patientCard.diagnosis')} defaultOpen={defaultOpen}>
      {isEditing ? (
        <>
          <Textarea
