...
const ru = {
  ...
  addPatient: {
    ...
    successWithVisit: 'добавлен с первым визитом',
    visitNotSaved: 'Пациент создан, но визит не сохранён. Добавьте его вручную.',
  ...
  patientDetails: {
    ...
    genderSaved: 'Пол сохранён',
    selectSegment: 'Выберите сегмент',
    segmentVipSet: 'Пациент отмечен как VIP',
    segmentRegularSet: 'Пациент отмечен как обычный',
    statusCompletedSet: 'Лечение завершено',
    statusInProgressSet: 'Лечение в процессе',
  ...
  subscription: {
    ...
    opening: 'Открытие...',
    hint: '💡 Подсказка: Пробный период длится 14 дней бесплатно. Подписка стоит 10000 драм в месяц.',
  ...
  voice: {
    ...
    recognitionError: 'Не удалось распознать голос. Попробуйте снова.',
    networkError: 'Ошибка сети. Проверьте подключение к интернету.',
    timeout: 'Время ожидания истекло. Попробуйте снова.',
    notSupported: 'Голосовой ввод не поддерживается в этом браузере.',
    notSupportedHint: 'Голосовой ввод недоступен. Используйте текстовый ввод.',
    micDeniedHint: 'Проверьте настройки браузера для разрешения доступа к микрофону.',
    recognitionHint: 'Попробуйте говорить чётче или проверьте микрофон.',
    useTextInput: 'Текстовый ввод',
    textInputHint: 'Введите данные вручную',
    startHint: 'Нажмите и говорите. AI распознает и заполнит данные.',
    stopHint: 'Нажмите для остановки',
  ...
  patientCard: {
    ...
    addMedicationTitle: 'Назначить препарат',
    medicationName: 'Название препарата',
    medicationNamePlaceholder: 'Например: Амоксициллин',
    medicationDosage: 'Дозировка',
    medicationDosagePlaceholder: 'Например: 500мг 2 раза в день',
    medicationComment: 'Комментарий врача',
    medicationCommentPlaceholder: 'Дополнительные указания...',
    medicationNameRequired: 'Введите название препарата',
    medicationAdded: 'Препарат назначен',
    medicationAddError: 'Не удалось добавить препарат',
    ...
    ai: {
      ...
      ask: 'Спросить AI',
      enterText: 'Введите текст запроса',
  ...
  treatmentPlan: {
    ...
    addError: 'Не удалось добавить этап',
