...
const en = {
  ...
  patientDetails: {
    ...
    segmentVipSet: 'Patient marked as VIP',
    segmentRegularSet: 'Patient marked as Regular',
    statusCompletedSet: 'Treatment completed',
    statusInProgressSet: 'Treatment in progress',
