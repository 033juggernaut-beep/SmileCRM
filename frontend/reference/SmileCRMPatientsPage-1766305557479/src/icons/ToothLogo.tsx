/**
 * Minimal tooth logo icon - outline style
 * Professional medical aesthetic without emotion
 * BRAND CONSISTENCY: This icon must be identical across all SmileCRM pages
 */
...
export function ToothLogo({ className = '' }: ToothLogoProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
